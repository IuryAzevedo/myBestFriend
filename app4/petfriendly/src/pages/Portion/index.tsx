...
import { View, Text, StyleSheet, Keyboard, TouchableWithoutFeedback, TouchableOpacity, TextInput, Modal, Image } from "react-native";
...
export default function Portion() {
  ...
  return (
    <View style={styles.container}>
      <View>
        <TouchableOpacity onPress={() => setModal(true)} style={styles.modalbutton}>
          {/* <Image source={require('../../assets/portionButton.png')} style/> */}
          <Text style={{fontSize: 24, fontWeight: "bold", color: "white"}}>Add Portion</Text>
        </TouchableOpacity>
      </View>
      <Modal animationType="slide" transparent={true} visible={modal}>
        ...
        <TouchableWithoutFeedback onPress={dismissKeyboard}>
          <View style={styles.modal}>
            <TouchableOpacity onPress={() => setModal(false)} style={styles.closeModalButton}>
